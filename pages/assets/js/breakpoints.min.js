var breakpoints = (function() {
    ...
    var t = {
        ...
        init: function(e) {
            t.list = e;
            if (typeof window !== "undefined") { // Vérifier si 'window' est défini
        ...
        active: function(e) {
            ...
            return t.media[e] !== !1 && typeof window !== "undefined" && window.matchMedia(t.media[e]).matches; // Vérifier si 'window' est défini
        },
        on: function(e, n) {
            t.events.push({
                query: e,
            ...
            if (typeof window !== "undefined" && t.active(e)) n(); // Vérifier si 'window' est défini
        },
        poll: function() {
            var e, n;
    ...
    if (typeof window !== "undefined") t.init(); // Vérifier si 'window' est défini
